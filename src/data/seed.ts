...
export const dailyChallenges = [
  { question: 'explore outer space or the deep ocean?', tag: 'Would You Rather', optionA: 'Space', optionB: 'Ocean' },
  { question: 'have the power of invisibility or flight?', tag: 'Would You Rather', optionA: 'Invisibility', optionB: 'Flight' },
  { question: 'What is one thing you’re grateful for today?', tag: 'Question', optionA: undefined, optionB: undefined },
  { question: 'always have to sing instead of speak, or dance everywhere you walk?', tag: 'Would You Rather', optionA: 'Sing', optionB: 'Dance' },
  { question: 'be the best player on a losing team or the worst player on a winning team?', tag: 'Would You Rather', optionA: 'Best on losing team', optionB: 'Worst on winning team' },
  { question: 'have a pet dragon or a pet unicorn?', tag: 'Would You Rather', optionA: 'Dragon', optionB: 'Unicorn' },
  { question: 'live in a treehouse or a houseboat?', tag: 'Would You Rather', optionA: 'Treehouse', optionB: 'Houseboat' },
  { question: 'never use social media again or never watch another movie/show?', tag: 'Would You Rather', optionA: 'No social media', optionB: 'No movies/shows' },
  { question: 'be able to talk to animals or speak every human language?', tag: 'Would You Rather', optionA: 'Talk to animals', optionB: 'Speak every language' },
  { question: 'have unlimited pizza for a year or unlimited ice cream for a year?', tag: 'Would You Rather', optionA: 'Pizza', optionB: 'Ice cream' },
  { question: 'be able to fly or be invisible?', tag: 'Would You Rather', optionA: 'Fly', optionB: 'Invisible' },
  { question: 'always be 10 minutes late or always be 20 minutes early?', tag: 'Would You Rather', optionA: '10 min late', optionB: '20 min early' },
